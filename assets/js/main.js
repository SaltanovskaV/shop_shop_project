//подсчет количества товаров, добавленных в корзину
//временный вывод суммы товаров, добавленных в корзину, в кнопку
//предусмотреть корректную работу при двойном клике на кнопке добавления товара
